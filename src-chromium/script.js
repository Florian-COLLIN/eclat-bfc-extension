...
document.getElementById("qqch").innerHTML = "<li class=\"services-sublist__item\"><a href=\"https://florian-collin.github.io/eclat-bfc-extension/\">Better Eclat-BFC</a></li><li class=\"services-sublist__item\"><a href=\"#changelogBetter\" onclick=\"open_Changelog()\">Journal des modifications</a></li>";
...
function open_Changelog() {
    window.open('html/changelog.html', "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");
}
